    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4 sm:p-6 lg:p-8">
      ...
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="hidden md:block relative">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#7d224bcc] to-black/40" />
        ...
        <div className="md:hidden w-full">
          <img src={university} alt="university" className="w-full h-40 sm:h-56 object-cover" />
