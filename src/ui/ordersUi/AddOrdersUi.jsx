...
import { addOrdersForm } from "../../lib/actions";
...
export default function AddOrdersUi({ servicesData, storesData }) {
    ...
    const handleSubmit = async (e) => {
        setLoading(true);
        e.preventDefault();
        const result = await addOrdersForm(new FormData(e.target), navigate);
        setLoading(false);
    ...
    if (((servicesData).length < 1) || ((storesData).length < 1)) {
