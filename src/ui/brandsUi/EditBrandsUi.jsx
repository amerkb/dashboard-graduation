...
export default function EditBrandsUi({ data }) {
    ...
    const handleSubmit = async (e) => {
        ...
        e.preventDefault();
        const result = await updateBrandsForm(data.id, new FormData(e.target), navigate);
        setLoading(false);
    };
    ...
    if (Object.keys(data).length < 1) {
        return <div className=" h-[70vh] flex justify-center items-center"><AnimationLoader animationData={animation} /></div>
    };
