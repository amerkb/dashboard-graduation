...
import { addServicesForm } from "../../lib/actions";
...
export default function AddServicesUi({ serviceData }) {
    ...
    const handleSubmit = async (e) => {
        setLoading(true);
        e.preventDefault();
        const result = await addServicesForm(new FormData(e.target), navigate);
        setLoading(false);
        ...
        <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1  md:grid-cols-2 sm:grid-cols-1 gap-3">
                ...
                <div className="mb-4">
                    ...
                    <DropDown options={serviceData} value={categoryId} onchange={onchange} paramkey={"category_service_id"} defaultText="أختر فئة الخدمة" />
                </div>
            </div>
            {/* add dropdwon here  */}
